...
Your data contract is the heart of your application. It lives at [`server/src/db/prisma/contract.prisma`](../db/prisma/contract.prisma) and describes your models:
...
```typescript
import { db } from './server/src/db/prisma/db';
...
export default definePrismaConfig({
  orm: ormConfig({
    contract: './server/src/db/prisma/contract.prisma',
    db: {
...
| File | Purpose |
|---|---|
| [`server/src/db/prisma/contract.prisma`](../db/prisma/contract.prisma) | Your data contract — define your models here |
| [`prisma.config.ts`](../../../prisma.config.ts) | CLI configuration |
| [`server/src/db/prisma/db.ts`](../db/prisma/db.ts) | Database client — `import { db } from './server/src/db/prisma/db'` |
| `server/src/db/prisma/contract.json` | Compiled contract (generated) |
| `server/src/db/prisma/contract.d.ts` | Contract types (generated) |

### Workflow

1. Edit [`server/src/db/prisma/contract.prisma`](../db/prisma/contract.prisma) to add or change models.
