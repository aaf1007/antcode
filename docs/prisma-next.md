...
Your data contract is the heart of your application. It lives at [`database/prisma/contract.prisma`](database/prisma/contract.prisma) and describes your models:
...
| File | Purpose |
|---|---|
| [`database/prisma/contract.prisma`](database/prisma/contract.prisma) | Your data contract — define your models here |
| [`prisma.config.ts`](prisma.config.ts) | CLI configuration |
| [`database/prisma/db.ts`](database/prisma/db.ts) | Database client — `import { db } from './database/prisma/db'` |
| `database/prisma/contract.json` | Compiled contract (generated) |
| `database/prisma/contract.d.ts` | Contract types (generated) |

### Workflow

1. Edit [`database/prisma/contract.prisma`](database/prisma/contract.prisma) to add or change models.
