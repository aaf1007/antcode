 ...
 * plain objects that the service and API layers can return. Integration tests
 * against a real database can verify the Sequelize configuration separately.
 */
import assert from "node:assert/strict";
import { afterEach, describe, it, mock } from "node:test";

import { Problem as ProblemModel } from "./problem.model";
import { findAllSnippets, findProblemById } from "./problem.repository";
